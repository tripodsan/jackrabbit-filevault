...
public class PropertyTests {
    ...
    static {
        TEST_PROPERTIES.put("STRING_PROPERTY", "Hello, world.");
    }
    @Test
    public void testProperty() throws Exception {
        AnnotationTransformer transformer = new AnnotationTransformer();
        PropertyExample propertyExample = new PropertyExample();
        Map<String, Object> properties = transformer.collectProperties(propertyExample);
        assertEquals("Properties", TEST_PROPERTIES, properties);
    }
