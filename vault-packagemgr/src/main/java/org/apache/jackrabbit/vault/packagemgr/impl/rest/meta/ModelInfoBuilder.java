...
public class ModelInfoBuilder {
    ...
    public ModelInfoBuilder withSelfURI(URI selfURI) {
        this.selfURI = selfURI;
        return this;
    }

    public ModelInfoBuilder withBaseURI(URI baseURI) {
        this.baseURI = baseURI;
        return this;
    }

    public ModelInfoBuilder withModel(Object model) {
        this.model = model;
        return this;
    }

    private ModelInfoBuilder withParentModel(Object parentModel) {
    ...
    public ModelInfo build() throws IOException {
        try {
            ...
            // actions
            Collection<ActionInfo> actions = collectActions();
            ...
            return new ModelInfo(model, actions, builder.build());
